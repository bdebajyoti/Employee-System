...
ResultSet rs;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DELETE_EMPLOYEE_INFORMATION");
        ...
        jButton2.setText("Delete_Emp_Info");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        String sql="select * from employee where empid='"+id.getText()+"'";
      try
      {
          ...
          if(rs.next())
          {
              JOptionPane.showMessageDialog(this,"Data Matched");
              ...
              accnum.setText(rs.getString("accnumber"));
              ifsc.setText(rs.getString("ifsccode"));
              photo.setText(rs.getString("photo"));
              
          }
          else
          {
              JOptionPane.showMessageDialog(this,"Data Not Exist Matched");
          }
      }catch(Exception ex)
      {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        String sql="delete from employee where empid='"+id.getText()+"'";
        try
        {
            pst=conn.prepareStatement(sql);
            pst.execute();
