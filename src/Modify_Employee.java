...
/**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MODIFY_EMPLOYEE_INFORMATION");
        ...
        jButton2.setText("Update Emp_info");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sql="update employee set fname='"+fname.getText()+"',lname='"+lname.getText()+"',education='"+education.getText()+"',contact='"+contact.getText()+"',address='"+address.getText()
                +"',father='"+father.getText()+"',mother='"+mother.getText()+"',bankname='"+bank.getText()+"',accnumber='"+accnum.getText()+"',ifsccode='"
                +ifsc.getText()+"',photo='"+photo.getText()+"' where empid='"+id.getText()+"'";
        try
        {
            pst=conn.prepareStatement(sql);
            pst.executeUpdate();
